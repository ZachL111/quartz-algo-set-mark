...
$repo = "quartz-algo-set-mark"
$language = "OCaml"
$category = "Algorithms"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/quartz-algo-set-walkthrough.md")) {
